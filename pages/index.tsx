...
const IndexPage = () => (
    <Layout title="Coming Soon - initZero">
        <img
            src="/images/xera.svg"
            alt="InitZero "
        ...
        <div className="relative z-10 py-6 space-y-16 lg:space-y-32 text-gray-900">
            ...
            <form className="relative z-10 mx-10 lg:max-w-xl lg:mx-auto"
                  action="https://gmail.us14.list-manage.com/subscribe/post?u=7fae5b7ea114a897fa1ee6186&amp;id=d074d4a038"
                  method="post" name="mc-embedded-subscribe-form">
                <input
                    id="mce-EMAIL"
                    name="EMAIL"
                    type="text"
                    placeholder="hi@izero.dev"
